...
def test_validate_and_ground_salary_grounded_pass_through():
...
def test_validate_and_ground_ungrounded_salary_is_dropped():
    # A plausible-looking figure that never actually appears in the
