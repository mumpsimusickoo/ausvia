...
NOT_CONFIGURED_NOTE = "AI classification isn't available (no AI provider is configured)."
...
def classify_reply(user, application, message):
    ...
    if provider.provider_name == "mock":
        ...
        message.classification_notes = NOT_CONFIGURED_NOTE
    ...
    try:
        ...
        message.classification_notes = f"Classification failed: {e}"
