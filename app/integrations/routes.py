...
def gmail_connect():
    ...
    try:
        ...
        flash(_("Could not start the Gmail connection. Please try again."), "error")
...
def gmail_callback():
    ...
    if request.args.get("error"):
        flash(_("Gmail connection was cancelled or denied."), "info")
        return redirect(url_for("integrations.gmail_status"))

    if not expected_state or expected_state != returned_state:
        flash(_("Gmail connection failed - the request could not be verified. Please try again."), "error")
    ...
    try:
        ...
        flash(_("Could not complete the Gmail connection. Please try again."), "error")
    ...
    flash(_("Gmail connected."), "success")
    return redirect(url_for("integrations.gmail_status"))
...
def gmail_disconnect():
    ...
    flash(_("Gmail disconnected."), "info")
    return redirect(url_for("integrations.gmail_status"))
